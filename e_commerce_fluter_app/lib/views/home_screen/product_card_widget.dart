...
import 'package:e_commerce_fluter_app/views/product_detials_screen/product_detials_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Scaffold.of(context).showBottomSheet(
          (context) => const ProductDetilasScreen(),
        );
      },
      child: Padding(
                  ...
                  RichText(
                    ...
                    text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(
                          text:
                              ProductdummyData.products[index].price.toString(),
